<template>
  <div class="container">
    ...
    <button @click="del" class="bt_delete">删除</button>
    ...
    <div class="wrapper">
      ...
      <table>
        <colgroup>
          <col name="col1" width="40px">
          <col name="col2" width="40px">
          <col name="col3">
        </colgroup>
        <thead>
        <tr>
    ...
    <div id="popout_upload">
      ...
      <button class="bt_close" @click="togglePopOut"><img src="../../static/image/close.png"
                                                                            width="45" height="45"></button>
    </div>
  </div>
</template>
